...
create_seed(){
  npx near call --accountId $ADMIN_ID $CONTRACT_NAME 'create_seed' "{\"vtype\": $1, \"vsubtype\": $2, \"meta_url\": \"$3\", \"rarity\":$4, \"edition\": $5}" 
        ...
        create_seed $vtypes[PLANT] $ptypes[ORACLE] \
    ...
    "https://arweave.net/33wa-6hW_vQAbkQ4a5ZXX7HGJMGR3M8ej-z9dvcnJ8k"\
        ...
        create_seed $vtypes[PLANT] $ptypes[PORTRAIT] \
    ...
    "https://arweave.net/M7uwpTyRIZIohXBgIZUqoYDyxq1GyH3fkoT7CvN2iLE"\
        ...
        create_seed $vtypes[PLANT] $ptypes[MONEY] \
    ...
    "https://arweave.net/dPBN2DGba13xI7IFqBoczspsHbTXUvmZ9sjKIuhU28o"\
      ...
      create_seed $vtypes[HARVEST] $ptypes[ORACLE] \
  ...
  "https://arweave.net/eYJ3Ie8K3sVwvXSH5xtXtyi8PizJCzkXK4n7MCCMunE"\
      ...
      create_seed $vtypes[HARVEST] $ptypes[PORTRAIT] \
